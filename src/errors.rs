...
pub enum DriftError {
    ...
    #[error("Remaining account passed is not a valid pda")]
    ...
    #[error("Ed25519 Ix must be before place and make swift order ix")]
    InvalidVerificationIxIndex = 6285,
    #[error("Swift message verificaiton failed")]
    SigVerificationFailed = 6286,
    #[error("Market index mismatched b/w taker and maker swift order params")]
    MismatchedSwiftOrderParamsMarketIndex = 6287,
    #[error("Swift only available for market/oracle perp orders")]
    InvalidSwiftOrderParam = 6288,
